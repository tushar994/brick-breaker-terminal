    ...
    def ball_collide(self, ball, bricks, index1, index2):
        ...
        if(not (ball.x > self.x + 2 or ball.x + 1< self.x or ball.y > self.y + 2 or ball.y + 1< self.y)):
            ...
            # check if it hit in x direction
                ...
                if((ball.x == self.x-1) and (ball.y==self.y+2) and (ball.dx>0) and (ball.dy<0)):
                    ball.dx *=-1
                    ball.dy *=-1
                    actually =1
                    ...
                    actually =1
                elif((ball.x == self.x+2) and (ball.y==self.y+2) and (ball.dx<0) and (ball.dy<0)):
                    ball.dx *=-1
                    ball.dy *=-1
                    actually =1
                elif((ball.x == self.x+2) and (ball.y==self.y-1) and (ball.dx<0) and (ball.dy>0)):
                    ball.dx *=-1
                    ball.dy *=-1
                    actually =1
